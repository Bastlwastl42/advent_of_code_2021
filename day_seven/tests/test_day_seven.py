...
from day_seven.day_seven import data_refinement, part_one, part_two
...
class TestDay07(unittest.TestCase):
    ...
    def test_part_one(self):
        """test part one"""
        self.assertEqual((2, 37), part_one(self.input_data))

    def test_part_two(self):
        """Test part two"""
        self.assertEqual((5, 168), part_two(self.input_data))
