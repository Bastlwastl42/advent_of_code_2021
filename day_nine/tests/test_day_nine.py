...
from day_nine.day_nine import data_refinement, part_one, part_two
...
class TestDay09(unittest.TestCase):
    ...
    def test_part_one(self):
        """test part one"""
        self.assertEqual(15, part_one(self.input_data))

    def test_part_two(self):
        """Test part two"""
        self.assertEqual(1134, part_two(self.input_data))
