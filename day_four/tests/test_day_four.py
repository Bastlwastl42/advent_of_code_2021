...
from day_four.day_four import data_refinement, part_one, part_two
...
class TestDay04(unittest.TestCase):
    ...
    def test_part_one(self):
        """test part one"""
        self.assertEqual(4512, part_one(self.input_data))

    def test_part_two(self):
        """Test part two"""
        self.assertEqual(1924, part_two(self.input_data))
